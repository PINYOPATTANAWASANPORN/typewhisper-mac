...
final class PluginDictionaryGuardTests: XCTestCase {
    ...
    func testDeepgramSupportedLanguagesForNova3IncludesArabicKazakhAndHebrew() {
        ...
        XCTAssertTrue(nova3Languages.contains("ar-SA"), "Nova-3 should support Arabic Saudi Arabia (ar-SA)")
        XCTAssertTrue(nova3Languages.contains("af"), "Nova-3 should support Afrikaans (af)")
        XCTAssertTrue(nova3Languages.contains("ur"), "Nova-3 should support Urdu (ur)")
        ...
        XCTAssertTrue(nova3Languages.contains("zh-Hant"), "Nova-3 should support Traditional Chinese (zh-Hant)")
    ...
    func testDeepgramSupportedLanguagesForNova2ExcludesNova3OnlyLanguages() {
        ...
        XCTAssertFalse(nova2Languages.contains("af"), "Nova-2 should not advertise Afrikaans (af)")
        XCTAssertFalse(nova2Languages.contains("ur"), "Nova-2 should not advertise Urdu (ur)")
        ...
        XCTAssertTrue(nova2Languages.contains("da-DK"), "Nova-2 should support Danish Denmark (da-DK)")
        XCTAssertTrue(nova2Languages.contains("zh-Hant"), "Nova-2 should support Traditional Chinese (zh-Hant)")
